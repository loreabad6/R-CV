...
data.frame(
  ...
  Spanish = cell_spec(c(rep("Native", 4)), 'latex', color = '#009acd'), # #005c7b
  English = cell_spec(c("C2","C1","C2","C2"), 'latex', color = '#009acd'), # #009acd
  French = cell_spec(c("B2","B2","B2","B2"), 'latex', color = '#009acd'), # #4cb8dc
  Portuguese = cell_spec(c("B1","B1","B1","B1"), 'latex', color = '#009acd'), # #4cb8dc
  German = cell_spec(c("A2","A1","B1","B1"), 'latex', color = '#005c7b'), # #7fcce6
  Dutch = cell_spec(c("A2","A1","A2","A2"), 'latex', color = '#009acd') # #7fcce6
) %>%
