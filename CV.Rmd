...
exp %>%
  ...
  mutate(description = c(
    'Using remote sensing and GIS to study natural geohazards and their interrelations for the MontEO, STEC, RiCoLa projects in the Landslide division of the Risk, Hazard & Climate research group.',
...
tribble(
  ...
  # "Erasmus Mundus Msc. Geospatial Technologies", "Universidade Nova de Lisboa", "Lisbon, Portugal", "2017 - 2019", "S1 2017: Group Project Seminar (covering Python and PostGIS)",
    # "Erasmus Mundus Msc. Geospatial Technologies", "Universidade Nova de Lisboa", "Lisbon, PT", "2017 - 2019", "S1, 2017: covering Geospatial Data Mining, Geostatistics, Remote Sensing, Geographic Information Science, Python programming.",
      # "Erasmus Mundus Msc. Geospatial Technologies", "Universidade Nova de Lisboa", "Lisbon, PT", "2017 - 2019", NA,
...
tribble(
  ...
  "QGIS -- ArcGIS -- SAGA -- eCognition -- PostgreSQL -- PostGIS -- RStudio --  Earth Engine -- GIMP -- Mendeley",
...
data.frame(
  ...
  German = cell_spec(c("B1","B1","B1","B1"), 'latex', color = '#7fcce6'), 
