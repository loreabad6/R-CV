...
\faIcon{lightbulb} Current Projects
=====================================
...
tribble(
  ~ name, ~ acronym, ~ type,
  "Tidy Geospatial Networks in R", "\\href{https://luukvdmeer.github.io/sfnetworks/}{sfnetworks}", "R Package"
) %>% 
...
data.frame(
  ...
  row_spec(0:4, extra_latex_after = "\\arrayrulecolor{white}\\hline")
```
