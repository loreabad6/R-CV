...
See the complete list on [Google Scholar](https://scholar.google.com/citations?user=vDqPwpUAAAAJ&hl=en).

```{r pubs}
tribble(
  ~ name, ~ journal, ~ date, ~type, ~ bib,
  # "Detecting landslide-dammed lakes on Sentinel-2 imagery and monitoring their spatio-temporal evolution after the Kaikōura earthquake in New Zealand", "Submitted to Remote Sensing of Environment","07, 2020", "Journal Article","",
  ...
  # "Assessing the impact of mass movements on alpine trails and huts using EO data.","EGU General Assembly 2020","03, 2020","Conference Proceedings","Albrecht, F., Hölbling, D., \\text{Abad, L.}, Dabiri, Z., Reischenböck, G., Hipp, T., Resch, H., & Resch, G. (2020). Assessing the impact of mass movements on alpine trails and huts using EO data. EGU General Assembly 2020. \\textit{https://doi.org/10.5194/egusphere-egu2020-21325}",
...
tribble(
  ...
  "The impact of mass movements on alpine trails and huts assessed by EO data", "MontEO \\href{http://monteo.zgis.at/}{\\faIcon{link}}", "2020 - 2021", "AT", 
  "Detection and Analysis of Landslide-induced River Course Changes and Lake Formation", "RiCoLa \\href{http://landslides-and-rivers.sbg.ac.at/}{\\faIcon{link}}", "2017 - 2020", "AT, NZ, TW", 
  "Observation and Reporting of Landscape Dynamics by Citizens", "citizenMorph \\href{http://citizenmorph.sbg.ac.at/}{\\faIcon{link}}", "2018 - 2020", "AT, DE, IS", 
  "Mapping, Monitoring and Modelling the Spatio-Temporal Dynamics of Land Surface Morphology", "MORPH \\href{http://morph.sbg.ac.at/}{\\faIcon{link}}", "2016 - 2020", "IS"
) %>% 
...
tribble(
  ~ name, ~ acronym, ~ type,
  "Tidy Geospatial Networks in R", "sfnetworks \\href{https://luukvdmeer.github.io/sfnetworks/}{\\faIcon{link}}", "R Package",
  "Bicycle Network Analysis Score for UK and NL",
  "BNA-EU \\href{https://github.com/loreabad6/masters-thesis-geotech}{\\faIcon{link}}", "RMarkdown Reporting"
) %>% 
...
tribble(
  ...
  "Implementing geo citizen science solutions: experiences from the citizenMorph project", "Full paper presentation in session C43: Spatial Citizens Science \\href{https://www.conftool.com/giweek2020/index.php?page=browseSessions&form_session=202}{\\faIcon{link}}", "Gi-Forum 2020", "07, 2020",
  "Tidy Geospatial Networks in R: Introducing the sfnetworks package", "Webinar \\& Hackathon \\href{https://sfnetworks.github.io/sfnetworks-webinar/slides}{\\faIcon{link}}", "e-Rum 2020 satellite event", "06, 2020",
  "Mapping and monitoring of landslide-dammed lakes using Sentinel-2 time series - a case study after the 2016 Kaikōura Earthquake in New Zealand", "Display in session NH6.1: Application of remote sensing and Earth-observation data in natural hazard and risk studies \\href{https://presentations.copernicus.org/EGU2020/EGU2020-572_presentation.pdf}{\\faIcon{link}}", "EGU 2020", "05, 2020",
  "Intro to spatial vector data analysis with R","R spatial crash course \\href{https://luukvdmeer.github.io/maptimeR/exercises.html}{\\faIcon{link}}", "Maptime Salzburg", "02, 2020",
  "Spatial networks in R with sf and tidygraph", "Blogpost \\href{https://www.r-spatial.org/r/2019/09/26/spatial-networks.html}{\\faIcon{link}}", "r-spatial blog", "09, 2019"
) %>% 
...
\faIcon{users} Organizations
===============================
```{r org}
tribble(
  ~ org, ~ date,
  "R-Ladies Global \\href{https://rladies.org/austria-rladies/name/lorena-abad/}{\\faIcon{link}}", "since 2020",
  "Women in Geospatial \\href{https://speakers.womeningeospatial.org/speakers}{\\faIcon{link}}", "since 2020",
  "European Geosciences Union Member", "2020",
...
tribble(
  ~ event, ~ date,
  "e-Rum 2020 satellite event: \\textit{sfnetworks} Webinar and Hackathon \\href{https://2020.erum.io/program/hackathon/}{\\faIcon{link}}", "06, 2020",
  "GeoMundus 2018 \\href{http://www.geomundus.org/2018/}{\\faIcon{link}}", "12, 2018",
  "I University Simposium of Environmental Science Research", "06, 2016",
  "Vicepresident of the Student Association of Environmental Engineers", "2013 - 2014"
) %>% 
  brief_entries(what = event, when = date, .protect = F)
```
