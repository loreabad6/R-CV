...
exp %>%
  ...
  mutate(description = c(
    'Using remote sensing and GIS to study natural geohazards and their interrelations for the MontEO, STEC, RiCoLa, MORPH, citizenMORPH projects in the Landslide division of the Risk, Hazard & Climate research group.',
