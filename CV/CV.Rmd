...
ggplot(data = world) +
  ...
  coord_sf(crs = 54030, xlim = c(-10000000, 4500000), ylim = c(-390000,6100000)) +
  theme_minimal() +
  theme(
...
exp$`0000-0003-0554-734X`$`employment-summary` %>%
...
tribble(
  ...
  "Environmental Engineer BSc.", "Universidad de Cuenca", "Cuenca, EC", "2011 - 2016", "Bachelor Thesis: Particulate Matter less than 10 microns concentration estimation through Remote Sensing in the Urban Area of Cuenca city.",
...
ggplot(aes(a, b)) + 
  ...
  expand_limits(y = c(0.3,2.5), x = c(-0.7,6)) +
  theme(
    ...
    axis.text.y = element_text(vjust = 0.5, size = 8, margin = margin(r = 20))
  )
